...
class VehiclesCard extends Component {
    ...
    render() {
        const { name, model, manufacturer, costInCredits, lengthOfShip, mAS, crew, passengers, cargoCapacity, consumables, vehicleClass, pilots, films } = this.props;
        const handleClick = () => {
        ...
        return (
            <div>
                ...
                >
                    ...
                    <p key='vehicleClass'><strong>Starship class: </strong>{vehicleClass}</p>
